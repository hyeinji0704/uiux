//html 문서가 모두 로딩된 이후에 1번 실행
$(document).ready(function(){

    let window_w = $(window).width()
    let device_status = 'pc' //pc버전인지 모바일 버전인지 구별
    ...
    메뉴에 마우스를 이웃하면 (메뉴를 벗어나면) 
    -- 오버해서 생긴 흰배경을 벗어나 아웃됨
        .header
    header에서 menu_open라는 클래스를 삭제*/
    ...
    //tab키로만 메뉴를 이동했을 때 메뉴에 접근하면 하위메뉴를 열어줘야함----키보드접근성
